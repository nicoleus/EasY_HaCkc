...
echo -e "                   $g"BATAK"$r"Team"$w"DZ"" 
echo -e "$a              # # # # # # # # # # # #"
echo -e "$a              #$G                     $o$a#"
echo -e "$a              #$G    $r"Nicoleus Sitorus  V3.2"$a   $o$a#"
echo -e "$a              #$G                     $o$a#"
echo -e "$a              # # # # # # # # # # # #"
echo
echo -e "  $G1$w Welcome to This Tool For Penetration Testing $o" 
echo -e $o"$green               Made by$yellow Nicoleus Sitorus "$o
echo -e " $g          Developers Team :  Nicoleus Sitorus "
echo " "
...
echo -n "[EasY_HaCk]~#:"
read tmp4
echo -e "$w My Facebook ID> $yellow Nicoleus Sitorus"
...
echo -e "$yellow "["$red "x"$yellow ]:[$w "Internet"$yellow ]:$red Not connected !"
sleep 20
$PREFIX/share/EasY_HaCk/EasY_HaCkc
fi
