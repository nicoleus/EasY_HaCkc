...
sleep 6
mkdir /sdcard/EasY_HaCkc
cd $dir
mkdir EasY_HaCkc-results
cd $dir
pip install -r EasY_HaCkc/.modules/.Infoga/requirements.txt
clear
sleep 1
pip2 install -r EasY_HaCkc/.modules/.recon-ng/REQUIREMENTS
clear
sleep 1
pip install PySocks
clear
...
cd $dir
rm -rf $HOME/EasY_HaCkc
sleep 3
clear
figlet -f small "   DONE Lae!"
echo "Now Type in new terminal ————>  HORAS"
sleep 3
HORAS
